<?php
include '../model/MCollection_Model.php';///include collection model

$colleObj = new collection();///create collection object

$status = $_REQUEST["status"];
switch ($status){
  case "add_m_collection":///for add collection
        ...
        try{
            ...
            $msg= "successfully inserted material collection " .$CollName;/////msg variable create
