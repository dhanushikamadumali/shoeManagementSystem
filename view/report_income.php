    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <nav aria-label="Breadcrumb" style="height:49px;">
                <ol class="breadcrumb">
                <h4 class="breadcrumb-item active" aria-current="page" style="color: #000;">INCOME REPORT</h4>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <select name="selecttime" id="selecttime" class="form-control">
                                    ...
                                    <option value="1">LAST 7 DAY INCOME</option>
                                    <option value="2">CUSTOME</option>
                                    <option value="3">LAST 2 MONTH INCOME</option>
                                    <option value="4">CURRENT YEAR INCOME</option>
                                    <option value="5">TODAY INCOME</option>
                                </select>
                                </div>
...
<script type="text/javascript">
    $("#selecttime").change(function(){
        ...
        $.ajax({
            url: "../controller/IncomeReportController.php?status=getreporttable",
            type:'POST',
            data:{se:se},
        ...
        $.ajax({
            url: "../controller/IncomeReportController.php?status=getreport",
            type:'POST',
            data:{se:se},
            success: function(res){
                console.log(res);
