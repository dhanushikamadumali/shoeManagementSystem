    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <nav aria-label="Breadcrumb" style="height:49px;">
                <ol class="breadcrumb">
                <h4 class="breadcrumb-item active" aria-current="page" style="color: #000;">SUPPLIER REPORT</h4>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <button id="active" name="active" class="btn btn-primary">SUPPLIER REPORT</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $("#active").on('click',function(){//get supplier report button click 
        $.ajax({
            url: "../controller/SupplierReportController.php?status=getreporttable",
            type:'POST',
        ...
        $.ajax({
            url: "../controller/SupplierReportController.php?status=getreport",
            type:'POST',
