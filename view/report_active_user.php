...
class PDF extends FPDF{//create class
    ...
    function TableHeading()///table heading function
    {
        ...
        $this->Cell(190,0,'ACTIVE USER REPORT',0,0,'C');
        $this->Ln();
    ...
    function TableBody(){///table body function
        ...
        $crrentyearResult1=$userReportObj->getuserReport();///get result user report model
        $currentYearResult3=$userReportObj->getActiveUser();///get result user report model
        $row3 = $currentYearResult3->fetch_assoc();////make a result as an array value
        $this->Cell(0,10,'',0,1);
        $this->SetFont("Arial","B","10");
        $this->Cell(32,10,'ACTIVE USER :',0,"",'L');
        $this->SetFont("Arial","","10");
        $this->Cell(10,10,$row3["ActiveUser"],0,"",'C');
        ...
        $this->SetFont("Arial","","10");
        $counter++;
        while($row1=$crrentyearResult1->fetch_assoc()){
