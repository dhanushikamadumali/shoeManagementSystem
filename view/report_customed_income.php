...
class PDF extends FPDF{//create class
    ...
    function TableHeading()///table heading function
    {
        ...
        $this->Cell(190,0,'DAY INCOME REPORT',0,0,'C');
        $this->Ln();
    ...
    function TableBody(){///table body function
        ...
        $WeeklyResult= $incomeReportObj->getWeeklyCustomedateReport($fromdate,$todate);//pass value to report model
        $WeeklyEVResult = $incomeReportObj->getWeeklyCustomedateEarnV($fromdate,$todate);//pass value to report model
