...
class PDF extends FPDF{//create class
    ...
    function TableHeading()///table heading function
    {
        ...
        $this->Cell(190,0,'CURRENT YEAR DELIVERY REPORT',0,0,'C');
        $this->Ln();
    ...
    function TableBody(){///table body function
        ...
        $crrentyearResult1=$deliveryReportObj->getCurrentYearReport();///get result report model
        $currentYearResult2=$deliveryReportObj->getCurrentYearSuccDelivery();///get result report model
        ...
        $this->SetFont("Arial","","10");
        $counter++;
        while($row=$crrentyearResult1->fetch_assoc()){
