    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <nav aria-label="Breadcrumb" style="height:49px;">
                <ol class="breadcrumb">
                <h4 class="breadcrumb-item active" aria-current="page" style="color: #000;">ORDER REPORT</h4>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <select name="selecttime" id="selecttime" class="form-control">
                                    ...
                                    <option value="1">LAST 7 DAY ORDER</option>
                                    <option value="2">CUSTOME</option>
                                    <option value="3">LAST 2 MONTH ORDER</option>
                                    <option value="4">CURRENT YEAR ORDER</option>
                                    <option value="5">TODAY ORDER</option>
                                </select>
                                </div>
...
<script type="text/javascript">
    $("#selecttime").change(function(){
        ...
        $.ajax({
            url: "../controller/OrderReportController.php?status=getOrderReportTable",
            type:'POST',
            data:{se:se},
        ...
        $.ajax({
            url: "../controller/OrderReportController.php?status=getAllOrderPlaceReport",
            type:'POST',
            data:{se:se},
            success: function(res){
                console.log(res);
