...
class PDF extends FPDF{//create class
    ...
    function TableHeading()///table heading function
    {
        ...
        $this->Cell(190,0,'LAST SEVEN DAY ORDER REPORT',0,0,'C');
        $this->Ln();
    ...
    function TableBody(){///table body function
        ...
        $SevenDayResult1=$OrderReportObj->getLastSevenDayAllOrderReport();///get result order report model
        $SevenDayResult2=$OrderReportObj->getLastSevenDayAllOrderPlace();///get result order report model
