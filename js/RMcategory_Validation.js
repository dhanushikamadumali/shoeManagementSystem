$(document).ready(function(){//when the document is loaded
    ...
    $("#addcollection").submit(function(){//////when the submit the form add new collection
        
        var CollName = $("#Collection_name").val(); // get the collection name

        if(CollName==""){//if collection name empty
            $("#CollectionAlert").html("Please Enter Material Collection Name");
    ...
    $("#addcategory").submit(function(){/////when the submit the form add category
        ...
        if($("input[type=checkbox]:checked").length < 1){//if checkbox empty
            $("#CategoryAlert").html("At least One row material collection must be selected");
    ...
    $("#addsubcategory").submit(function(){////when the submit the form add sub category
        ...
        if(CatName==""){//if category name empty
            $("#SubCategoryAlert").html("Please Select Material Category Name");
            $("#SubCategoryAlert").addClass("alert alert-danger");
            $("#Cat_id").focus();
            return false;
        }
        if(SubCatName==""){//if sub category name empty
            $("#SubCategoryAlert").html("Please Enter Material Sub Category Name");
            $("#SubCategoryAlert").addClass("alert alert-danger");
